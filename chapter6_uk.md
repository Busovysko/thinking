...
Щоб зрозуміти сенс специфікатор доступу ***protected***, необхідно трохи забігти вперед. Відразу скажу, що розуміння цього розділу не обов'язково до знайомства зі успадкуванням (глава 7). І все ж для отримання цілісного уявлення тут наводиться опис ***protected*** і приклади його використання.
...
<<<<<<< HEAD
Інша частина реалізації виглядає як зазвичай.
Якщо при створенні нового пакета використовується успадкування від класу, що знаходиться в іншому пакеті, новий клас отримує доступ тільки до відкритих (*** public ***) членам з вихідного пакета. (Звичайно, при успадкуванні в межах одного пакета можна отримати доступ до всіх членів з пакетним рівнем доступу.) Іноді творцеві базового класу необхідно надати доступ до конкретного методу похідним класам, але закрити його від всіх інших. Саме для цього завдання використовується ключове слово *** protected ***. Специфікатор *** protected *** також надає доступ в межах пакету - тобто члени з цим специфікатором доступні для інших класів з того ж пакета. Інтерфейс і реалізація
Контроль над доступом часто називають приховуванням реалізації. Приміщення даних і методів в класи в комбінації з приховуванням реалізації часто називають инкапсуляцией. В результаті з'являється тип даних, що володіє характеристиками і поведінкою.
Доступ до типам даних обмежується з двох причин. Перша причина -
щоб програмісту-клієнту знати, що він може використовувати, а що не може. Ви вільні вбудувати в структуру реалізації свої внутрішні механізми, не побоюючись того, що програмісти-клієнти завдяки випадку використовують їх в якості частини інтерфейсу.
